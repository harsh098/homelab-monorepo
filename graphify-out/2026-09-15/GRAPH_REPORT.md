...
Cohesion: 0.27
Nodes (9): helm_release.external_secrets, kubernetes_manifest.gcp_secret_store, kubernetes_manifest.openbao_secret_store, kubernetes_namespace_v1.external_secrets, kubernetes_secret_v1.openbao_external_secrets_token, provider.google, provider.helm, provider.kubernetes (+1 more)
...
Cohesion: 0.22
Nodes (8): Deploy AdGuard DNS, Homelab, Keycloak bootstrap and OIDC provisioning, Power outage recovery, Prerequisites, Provision the compute node, Routed libvirt management network, Terraform layers
