...
Cohesion: 0.24
Nodes (14): google_secret_manager_secret.keycloak_admin_recovery, google_secret_manager_secret_version.keycloak_admin_recovery_initial, helm_release.keycloak, kubernetes_namespace_v1.keycloak, kubernetes_secret_v1.keycloak_admin, kubernetes_secret_v1.keycloak_postgresql, local.keycloak_admin_recovery_bundle, local.keycloak_admin_username (+6 more)
...
Cohesion: 0.20
Nodes (9): Deploy AdGuard DNS, First Google login and an existing account, Homelab, Keycloak bootstrap credential recovery, Power outage recovery, Prerequisites, Provision the compute node, Routed libvirt management network (+1 more)
